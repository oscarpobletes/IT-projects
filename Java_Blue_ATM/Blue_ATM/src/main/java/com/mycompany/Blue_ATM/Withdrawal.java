...
public class Withdrawal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(427, 338));
    ...
    private void jButton_enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_enterActionPerformed
        ...
        double wth_amount=Double.parseDouble(jTextField1.getText());
        ...
        }else if (wth_amount>1000){
            JOptionPane.showMessageDialog(null, "You can only withdraw up to $1,000","Maximum amount exceeded",JOptionPane.ERROR_MESSAGE);
        }else{
            tr.withdrawal(wth_amount);
            tr.registerTransaction(type, wth_amount);
